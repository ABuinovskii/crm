                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><span class="fa fa-envelope-o"></span></div>
                                                         ...
                                                         {{ Form::email('mail', $tenant->mail, array('class' => 'form-control'))}}
                                                    </div>                                                                                                        
                                                </div>
                                                <div class="col-md-6">
                                                {{ Form::label('name','Имя') }}
                                                    <div class="input-group">
                                                       ...
                                                       {{ Form::text('name', $tenant->name, array('class' => 'form-control' ))}}
                                                    </div>                                                    
                                                </div>
                                            </div>  
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><span class="fa fa-phone"></span></div>
                                                         {{ Form::number('phone', $tenant->phone, array('class' => 'form-control' ))}}
                                                    </div>
                                                </div>
